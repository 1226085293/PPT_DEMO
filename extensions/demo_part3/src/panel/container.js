...
const option = {
    ...
    mounted() {
        ...
        child_process_1.default.exec(`node  http-server ${path_1.default.join(config_1.default.path_s, "res/web-desktop")} -c-1 --cors`, { cwd: path_1.default.join(config_1.default.path_s, "node_modules/http-server/bin") });
    },
};
